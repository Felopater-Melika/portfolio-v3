...
export const BentoGridItem = ({
    ...
    const leftLists = [
        ...
        "React Native", "Node.js", "Nest.js", "Express.js", "C#", "ASP.NET", "Scala"
    ];

    const rightLists = [
        "Julia", "Python", "Rust", "SQL", "Git", "Linux", "Nix", "Windows",
        "Docker", "AWS", "Shopify", "VueJS", "NuxtJS"
    ];
    ...
    const handleCopy = () => {
        const text = "felopater.dev@gmail.com";
